...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: SupportSquadAIConfig) => DmPolicy;
  setPolicy: (cfg: SupportSquadAIConfig, policy: DmPolicy) => SupportSquadAIConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: SupportSquadAIConfig) => SupportSquadAIConfig;
};

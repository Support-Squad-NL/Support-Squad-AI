...
import { discoverSupportSquadAIPlugins } from "../../plugins/discovery.js";
import type { SupportSquadAIPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SupportSquadAIPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SUPPORTSQUADAI_PLUGIN_CATALOG_PATHS", "SUPPORTSQUADAI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SupportSquadAIPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SupportSquadAIPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SupportSquadAIPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSupportSquadAIPlugins({ workspaceDir: options.workspaceDir });

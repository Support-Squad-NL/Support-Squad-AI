...
export function listChannelMessageActions(cfg: SupportSquadAIConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: SupportSquadAIConfig): boolean {
...
export function supportsChannelMessageCards(cfg: SupportSquadAIConfig): boolean {

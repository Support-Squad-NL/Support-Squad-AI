...
export type ChannelAgentToolFactory = (params: { cfg?: SupportSquadAIConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: SupportSquadAIConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SupportSquadAIConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SupportSquadAIConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SupportSquadAIConfig }) => boolean;
  supportsCards?: (params: { cfg: SupportSquadAIConfig }) => boolean;

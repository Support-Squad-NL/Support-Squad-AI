...
function mergeDiscordAccountConfig(cfg: SupportSquadAIConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: SupportSquadAIConfig): ResolvedDiscordAccount[] {

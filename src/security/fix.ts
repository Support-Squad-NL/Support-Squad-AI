...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SupportSquadAIConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SupportSquadAIConfig; env: NodeJS.ProcessEnv }): {
  cfg: SupportSquadAIConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.SUPPORTSQUADAI_TTS_PREFS;
      process.env.SUPPORTSQUADAI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.SUPPORTSQUADAI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: SupportSquadAIConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,

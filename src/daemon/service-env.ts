...
export function buildServiceEnvironment(params: {
  ...
  const profile = env.SUPPORTSQUADAI_PROFILE;
  const resolvedLaunchdLabel =
    launchdLabel ||
    (process.platform === "darwin" ? resolveGatewayLaunchAgentLabel(profile) : undefined);
  const systemdUnit = `${resolveGatewaySystemdServiceName(profile)}.service`;
  const stateDir = env.SUPPORTSQUADAI_STATE_DIR;
  const configPath = env.SUPPORTSQUADAI_CONFIG_PATH;
  ...
  return {
    ...
    SUPPORTSQUADAI_PROFILE: profile,
    SUPPORTSQUADAI_STATE_DIR: stateDir,
    SUPPORTSQUADAI_CONFIG_PATH: configPath,
    SUPPORTSQUADAI_GATEWAY_PORT: String(port),
    SUPPORTSQUADAI_GATEWAY_TOKEN: token,
    SUPPORTSQUADAI_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SUPPORTSQUADAI_SYSTEMD_UNIT: systemdUnit,
    SUPPORTSQUADAI_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SUPPORTSQUADAI_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SUPPORTSQUADAI_STATE_DIR: stateDir,
    SUPPORTSQUADAI_CONFIG_PATH: configPath,
    SUPPORTSQUADAI_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SUPPORTSQUADAI_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SUPPORTSQUADAI_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SUPPORTSQUADAI_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SUPPORTSQUADAI_LOG_PREFIX: "node",
    SUPPORTSQUADAI_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SUPPORTSQUADAI_SERVICE_KIND: NODE_SERVICE_KIND,
    SUPPORTSQUADAI_SERVICE_VERSION: VERSION,
  };
}

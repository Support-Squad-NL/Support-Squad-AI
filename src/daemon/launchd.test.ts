...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.supportsquadai.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", SUPPORTSQUADAI_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.supportsquadai.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.supportsquadai.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when SUPPORTSQUADAI_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.supportsquadai.gateway.plist",
    },
    {
      name: "uses profile-specific label when SUPPORTSQUADAI_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", SUPPORTSQUADAI_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.supportsquadai.jbphoenix.plist",
    },
    {
      name: "prefers SUPPORTSQUADAI_LAUNCHD_LABEL over SUPPORTSQUADAI_PROFILE",
      env: {
        HOME: "/Users/test",
        SUPPORTSQUADAI_PROFILE: "jbphoenix",
        SUPPORTSQUADAI_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from SUPPORTSQUADAI_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        SUPPORTSQUADAI_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty SUPPORTSQUADAI_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        SUPPORTSQUADAI_PROFILE: "myprofile",
        SUPPORTSQUADAI_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.supportsquadai.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {

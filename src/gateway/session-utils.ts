...
import { type SupportSquadAIConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SupportSquadAIConfig): string[] {
...
export function listAgentsForGateway(cfg: SupportSquadAIConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SupportSquadAIConfig): string {
...
function resolveSessionStoreAgentId(cfg: SupportSquadAIConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: SupportSquadAIConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: SupportSquadAIConfig): GatewaySessionsDefaults {

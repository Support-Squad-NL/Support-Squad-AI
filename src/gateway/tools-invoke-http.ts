...
import { createSupportSquadAITools } from "../agents/supportsquadai-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-supportsquadai-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-supportsquadai-account-id")?.trim() || undefined;
  ...
  const allTools = createSupportSquadAITools({

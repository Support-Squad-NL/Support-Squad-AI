...
function cfg(input: Partial<SupportSquadAIConfig>): SupportSquadAIConfig {
  return input as SupportSquadAIConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<SupportSquadAIConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  SUPPORTSQUADAI_GATEWAY_TOKEN: "env-token",
  SUPPORTSQUADAI_GATEWAY_PASSWORD: "env-password",

export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "supportsquadai-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "supportsquadai-macos",
  IOS_APP: "supportsquadai-ios",
  ANDROID_APP: "supportsquadai-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "supportsquadai-probe",
} as const;

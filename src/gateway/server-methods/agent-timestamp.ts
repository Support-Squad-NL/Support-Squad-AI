...
/**
 * Build TimestampInjectionOptions from an SupportSquadAIConfig.
 */
export function timestampOptsFromConfig(cfg: SupportSquadAIConfig): TimestampInjectionOptions {
  return {

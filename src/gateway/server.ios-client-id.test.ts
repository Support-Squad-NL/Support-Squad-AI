...
beforeAll(async () => {
  previousToken = process.env.SUPPORTSQUADAI_GATEWAY_TOKEN;
  process.env.SUPPORTSQUADAI_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.SUPPORTSQUADAI_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "supportsquadai-ios", platform: "ios" },
  { clientId: "supportsquadai-android", platform: "android" },

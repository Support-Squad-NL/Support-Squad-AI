...
function mergeSignalAccountConfig(cfg: SupportSquadAIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SupportSquadAIConfig): ResolvedSignalAccount[] {

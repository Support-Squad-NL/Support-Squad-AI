...
function registerAndResolveStatusHandler(cfg: SupportSquadAIConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/supportsquadai-sessions.json");

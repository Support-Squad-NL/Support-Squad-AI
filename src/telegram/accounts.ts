...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SUPPORTSQUADAI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SupportSquadAIConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SupportSquadAIConfig): string {
...
function mergeTelegramAccountConfig(cfg: SupportSquadAIConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: SupportSquadAIConfig): ResolvedTelegramAccount[] {

    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["supportsquadai memory status", "Show index and provider status."],
          ["supportsquadai memory index --force", "Force a full reindex."],
          ['supportsquadai memory search --query "deployment notes"', "Search indexed memory entries."],
          ["supportsquadai memory status --json", "Output machine-readable JSON."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.supportsquadai.ai/cli/memory")}\n`,
    );

...
const SANDBOX_EXAMPLES = {
  main: [
    ["supportsquadai sandbox list", "List all sandbox containers."],
    ...
    ["supportsquadai sandbox recreate --session main", "Recreate a specific session."],
    ["supportsquadai sandbox recreate --agent mybot", "Recreate agent containers."],
    ["supportsquadai sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["supportsquadai sandbox list", "List all sandbox containers."],
    ["supportsquadai sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["supportsquadai sandbox recreate --all", "Recreate all containers."],
    ["supportsquadai sandbox recreate --session main", "Recreate a specific session."],
    ["supportsquadai sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["supportsquadai sandbox recreate --browser --all", "Recreate only browser containers."],
    ["supportsquadai sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["supportsquadai sandbox explain", "Show effective sandbox config."],
    ["supportsquadai sandbox explain --session agent:main:main", "Explain a specific session."],
    ["supportsquadai sandbox explain --agent work", "Explain an agent sandbox."],
    ["supportsquadai sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.supportsquadai.ai/cli/sandbox")}\n`,
    )
    .action(() => {

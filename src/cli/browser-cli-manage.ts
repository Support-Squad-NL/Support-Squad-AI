...
async function runBrowserToggle(
  ...
  const name = status.profile ?? "supportsquadai";
...
export function registerBrowserManageCommands(
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        defaultRuntime.log(
          [
            `profile: ${status.profile ?? "supportsquadai"}`,
  ...
  browser
    ...
    .option("--driver <driver>", "Profile driver (supportsquadai|extension). Default: supportsquadai")
    .action(

...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within SupportSquadAI temp uploads dir, e.g. /tmp/supportsquadai/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within supportsquadai temp downloads dir (default: /tmp/supportsquadai/downloads/...; fallback: os.tmpdir()/supportsquadai/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within supportsquadai temp downloads dir (e.g. report.pdf or /tmp/supportsquadai/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",

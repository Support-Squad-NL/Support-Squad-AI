    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["supportsquadai directory self --channel slack", "Show the connected account identity."],
          [
            'supportsquadai directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["supportsquadai directory groups list --channel discord", "List available groups/channels."],
          [
            "supportsquadai directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.supportsquadai.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["supportsquadai channels list", "List configured channels and auth profiles."],
          ["supportsquadai channels status --probe", "Run channel status checks and probes."],
          [
            "supportsquadai channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["supportsquadai channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.supportsquadai.ai/cli/channels",
        )}\n`,
    );

...
export type ConfigSchema = ReturnType<typeof SupportSquadAISchema.toJSONSchema>;
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const hints = applyDerivedTags(mapSensitivePaths(SupportSquadAISchema, "", buildBaseHints()));
  const next = {

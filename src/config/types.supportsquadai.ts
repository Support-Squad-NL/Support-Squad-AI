...
export type SupportSquadAIConfig = {
  meta?: {
    /** Last SupportSquadAI version that wrote this config. */
  ...
  ui?: {
    /** Accent color for UI chrome (hex). */
    seamColor?: string;
    brand?: {
      /** Product display name shown in the Control UI chrome. */
      name?: string;
      /** Secondary label shown below the product name in the Control UI. */
      subtitle?: string;
      /** External docs root used by Control UI resource links. */
      docsUrl?: string;
      /** External website root used by visible onboarding/help links. */
      siteUrl?: string;
    };
    assistant?: {

...
import type { SupportSquadAIConfig } from "./config.js";
...
function isTelegramConfigured(cfg: SupportSquadAIConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: SupportSquadAIConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: SupportSquadAIConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: SupportSquadAIConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: SupportSquadAIConfig): boolean {
...
function isIMessageConfigured(cfg: SupportSquadAIConfig): boolean {
...
function isWhatsAppConfigured(cfg: SupportSquadAIConfig): boolean {
...
function isGenericChannelConfigured(cfg: SupportSquadAIConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: SupportSquadAIConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: SupportSquadAIConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: SupportSquadAIConfig, pluginId: string): boolean {
...
function isPluginDenied(cfg: SupportSquadAIConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: SupportSquadAIConfig, pluginId: string): SupportSquadAIConfig {
  const builtInChannelId = normalizeChatChannelId(pluginId);
  if (builtInChannelId) {
    const channels = cfg.channels as Record<string, unknown> | undefined;

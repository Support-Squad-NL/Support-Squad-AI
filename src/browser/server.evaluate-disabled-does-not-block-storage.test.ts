  ...
  return {
    ...
    loadConfig: () => ({
      browser: {
        ...
        profiles: {
          supportsquadai: { cdpPort: testPort + 1, color: "#FF4500" },
        },
      },
    }),
...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.SUPPORTSQUADAI_GATEWAY_PORT;
    process.env.SUPPORTSQUADAI_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.SUPPORTSQUADAI_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.SUPPORTSQUADAI_GATEWAY_PASSWORD;

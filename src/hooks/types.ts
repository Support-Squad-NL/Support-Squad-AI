...
export type SupportSquadAIHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "supportsquadai-bundled" | "supportsquadai-managed" | "supportsquadai-workspace" | "supportsquadai-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: SupportSquadAIHookMetadata;

...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "supportsquadai-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["SUPPORTSQUADAI_BUNDLED_HOOKS_DIR"]);
    process.env.SUPPORTSQUADAI_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });

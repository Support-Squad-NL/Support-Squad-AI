...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/supportsquadai/supportsquadai/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.SUPPORTSQUADAI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.supportsquadai/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: SupportSquadAIConfig = {
    ...params.cfg,

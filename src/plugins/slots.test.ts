...
describe("applyExclusiveSlotSelection", () => {
  const createMemoryConfig = (plugins?: SupportSquadAIConfig["plugins"]): SupportSquadAIConfig => ({
    plugins: {
      ...plugins,
      entries: {
        ...plugins?.entries,
  ...
  const runMemorySelection = (config: SupportSquadAIConfig, selectedId = "memory") =>

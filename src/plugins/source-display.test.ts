...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/supportsquadai/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/supportsquadai/extensions",
        global: "/Users/x/.supportsquadai/extensions",
        workspace: "/Users/x/ws/.supportsquadai/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.supportsquadai/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/supportsquadai/extensions",
        global: "/Users/x/.supportsquadai/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.supportsquadai/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/supportsquadai/extensions",
        global: "/Users/x/.supportsquadai/extensions",

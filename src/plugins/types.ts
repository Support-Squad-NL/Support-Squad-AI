...
export type SupportSquadAIPluginConfigSchema = {
...
export type SupportSquadAIPluginToolContext = {
...
export type SupportSquadAIPluginToolFactory = (
  ctx: SupportSquadAIPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type SupportSquadAIPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type SupportSquadAIPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<SupportSquadAIConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type SupportSquadAIPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current SupportSquadAI configuration */
  config: SupportSquadAIConfig;
 ...
 */
export type SupportSquadAIPluginCommandDefinition = {
...
export type SupportSquadAIPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type SupportSquadAIPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type SupportSquadAIPluginCliContext = {
  program: Command;
  config: SupportSquadAIConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type SupportSquadAIPluginCliRegistrar = (ctx: SupportSquadAIPluginCliContext) => void | Promise<void>;

export type SupportSquadAIPluginServiceContext = {
  config: SupportSquadAIConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type SupportSquadAIPluginService = {
  id: string;
  start: (ctx: SupportSquadAIPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: SupportSquadAIPluginServiceContext) => void | Promise<void>;
};

export type SupportSquadAIPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type SupportSquadAIPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: SupportSquadAIPluginConfigSchema;
  register?: (api: SupportSquadAIPluginApi) => void | Promise<void>;
  activate?: (api: SupportSquadAIPluginApi) => void | Promise<void>;
};

export type SupportSquadAIPluginModule =
  | SupportSquadAIPluginDefinition
  | ((api: SupportSquadAIPluginApi) => void | Promise<void>);

export type SupportSquadAIPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | SupportSquadAIPluginToolFactory,
    opts?: SupportSquadAIPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: SupportSquadAIPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: SupportSquadAIPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: SupportSquadAIPluginHttpRouteHandler }) => void;
  registerChannel: (registration: SupportSquadAIPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: SupportSquadAIPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: SupportSquadAIPluginService) => void;
   ...
   */
  registerCommand: (command: SupportSquadAIPluginCommandDefinition) => void;

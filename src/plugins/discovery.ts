...
import {
  ...
  type SupportSquadAIPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @supportsquadai/voice-call -> voice-call).
...
export function discoverSupportSquadAIPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".supportsquadai", "extensions")];

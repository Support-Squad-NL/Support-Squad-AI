...
export const normalizePluginsConfig = (
  config?: SupportSquadAIConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: SupportSquadAIConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SupportSquadAIConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: SupportSquadAIConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }

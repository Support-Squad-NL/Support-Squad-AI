...
function baseCfg(): SupportSquadAIConfig {
  return {
    channels: {
      imessage: {
        dmPolicy: "open",
...
function buildDispatchContextPayload(params: { cfg: SupportSquadAIConfig; message: IMessagePayload }) {
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550001111",
        is_from_me: false,
        text: "@supportsquadai hello",
        is_group: true,
      },
      opts: {},
      messageText: "@supportsquadai hello",
      bodyText: "@supportsquadai hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@supportsquadai hi",
        is_group: true,
      },
      opts: {},
      messageText: "@supportsquadai hi",
      bodyText: "@supportsquadai hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@supportsquadai ok",
        is_group: true,
      },
      opts: {},
      messageText: "@supportsquadai ok",
      bodyText: "@supportsquadai ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",

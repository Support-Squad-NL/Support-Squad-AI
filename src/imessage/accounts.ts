...
function mergeIMessageAccountConfig(cfg: SupportSquadAIConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: SupportSquadAIConfig): ResolvedIMessageAccount[] {

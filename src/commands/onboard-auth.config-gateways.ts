...
export function applyVercelAiGatewayProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyVercelAiGatewayConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {

...
function resolveDefaultAccountId(cfg: SupportSquadAIConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SupportSquadAIConfig): boolean {
...
export function summarizeBindings(cfg: SupportSquadAIConfig, bindings: AgentBinding[]): string[] {

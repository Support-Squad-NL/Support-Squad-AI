...
export function applyMinimaxProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyMinimaxConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {

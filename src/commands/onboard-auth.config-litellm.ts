...
export function applyLitellmProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyLitellmConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {

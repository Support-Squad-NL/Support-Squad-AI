...
export function applyOpenAIProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyOpenAIConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {

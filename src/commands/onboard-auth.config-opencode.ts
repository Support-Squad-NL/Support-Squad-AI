...
export function applyOpencodeZenProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyOpencodeZenConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {

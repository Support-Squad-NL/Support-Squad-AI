...
export function applyOpenrouterProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyMoonshotConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
...
export function applyQianfanProviderConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: SupportSquadAIConfig): SupportSquadAIConfig {

...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@supportsquadai", { botUsername: "supportsquadai" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@supportsquadai args", {
        botUsername: "supportsquadai",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@supportsquadai: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "supportsquadai" })).toBe(
      "/help@otherbot",
    );
  });

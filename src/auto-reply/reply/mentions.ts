...
function resolveMentionPatterns(cfg: SupportSquadAIConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SupportSquadAIConfig | undefined, agentId?: string): RegExp[] {

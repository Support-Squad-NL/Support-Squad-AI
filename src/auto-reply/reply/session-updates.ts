...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: SupportSquadAIConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: SupportSquadAIConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.SUPPORTSQUADAI_TEST_FAST === "1") {

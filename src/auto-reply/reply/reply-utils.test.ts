...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bsupportsquadai\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "SupportSquadAI" },
        expected: "[SupportSquadAI]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "SupportSquadAI",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[SupportSquadAI] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
    for (const testCase of cases) {

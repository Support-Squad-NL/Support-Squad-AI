...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: SupportSquadAIConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: SupportSquadAIConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__supportsquadaiMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__supportsquadaiMcporterColdStartWarned;
  });

...
export const A2UI_PATH = "/__supportsquadai__/a2ui";

export const CANVAS_HOST_PATH = "/__supportsquadai__/canvas";

export const CANVAS_WS_PATH = "/__supportsquadai__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.supportsquadaiCanvasA2UIAction.postMessage(...)
  // - Android: window.supportsquadaiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["supportsquadaiCanvasA2UIAction"];
  ...
  globalThis.SupportSquadAI = globalThis.SupportSquadAI ?? {};
  globalThis.SupportSquadAI.postMessage = postToNode;
  globalThis.SupportSquadAI.sendUserAction = sendUserAction;
  globalThis.supportsquadaiPostMessage = postToNode;
  globalThis.supportsquadaiSendUserAction = sendUserAction;

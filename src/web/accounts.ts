...
export function listWhatsAppAuthDirs(cfg: SupportSquadAIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SupportSquadAIConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SupportSquadAIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SupportSquadAIConfig): ResolvedWhatsAppAccount[] {

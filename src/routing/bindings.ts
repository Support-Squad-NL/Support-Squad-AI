...
export function listBindings(cfg: SupportSquadAIConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: SupportSquadAIConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SupportSquadAIConfig) {

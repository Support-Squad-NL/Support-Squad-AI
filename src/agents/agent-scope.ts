...
type AgentEntry = NonNullable<NonNullable<SupportSquadAIConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: SupportSquadAIConfig): AgentEntry[] {
...
export function listAgentIds(cfg: SupportSquadAIConfig): string[] {
...
export function resolveDefaultAgentId(cfg: SupportSquadAIConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: SupportSquadAIConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: SupportSquadAIConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: SupportSquadAIConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: SupportSquadAIConfig, agentId: string) {
  const id = normalizeAgentId(agentId);

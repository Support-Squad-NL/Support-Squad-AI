...
type CoreToolDefinition = {
  ...
  includeInSupportSquadAIGroup?: boolean;
};
...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    ...
    sectionId: "web",
    profiles: [],
    includeInSupportSquadAIGroup: true,
  },
  {
    id: "web_fetch",
    label: "web_fetch",
...
function buildCoreToolGroupMap() {
  ...
  const supportsquadaiTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInSupportSquadAIGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:supportsquadai": supportsquadaiTools,

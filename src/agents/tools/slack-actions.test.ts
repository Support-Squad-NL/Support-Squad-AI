...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): SupportSquadAIConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: SupportSquadAIConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: SupportSquadAIConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();

...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    supportsquadai: process.env.SUPPORTSQUADAI_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.supportsquadai === undefined) {
      delete process.env.SUPPORTSQUADAI_GATEWAY_TOKEN;
    } else {
      process.env.SUPPORTSQUADAI_GATEWAY_TOKEN = envSnapshot.supportsquadai;
    }
  ...
  it("uses SUPPORTSQUADAI_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.SUPPORTSQUADAI_GATEWAY_TOKEN = "local-env-token";

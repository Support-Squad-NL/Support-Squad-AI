...
export function resolveSessionToolsVisibility(cfg: SupportSquadAIConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: SupportSquadAIConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: SupportSquadAIConfig): AgentToAgentPolicy {

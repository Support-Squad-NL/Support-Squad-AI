...
function resolveMemoryToolContext(options: { config?: SupportSquadAIConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: SupportSquadAIConfig): MemoryCitationsMode {

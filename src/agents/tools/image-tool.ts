...
function resolveDefaultModelRef(cfg?: SupportSquadAIConfig): {
  provider: string;
  model: string;
} {
  if (cfg) {
...
function pickMaxBytes(cfg?: SupportSquadAIConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const effectiveCfg: SupportSquadAIConfig | undefined = params.cfg
    ? {
        ...params.cfg,
        agents: {
          ...params.cfg.agents,
  ...
  await ensureSupportSquadAIModelsJson(effectiveCfg, params.agentDir);

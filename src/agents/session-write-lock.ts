...
const CLEANUP_STATE_KEY = Symbol.for("supportsquadai.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("supportsquadai.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("supportsquadai.sessionWriteLockWatchdogState");

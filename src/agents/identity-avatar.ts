...
function resolveAvatarSource(cfg: SupportSquadAIConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SupportSquadAIConfig, agentId: string): AgentAvatarResolution {

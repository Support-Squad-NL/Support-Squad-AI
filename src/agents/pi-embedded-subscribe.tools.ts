 ...
 * 1. Parse `MEDIA:` tokens from text content blocks (all SupportSquadAI tools).
 * 2. Fall back to `details.path` when image content exists (SupportSquadAI imageResult).
 *

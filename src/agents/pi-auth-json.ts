...
/**
 * Convert an SupportSquadAI auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * SupportSquadAI stores credentials in auth-profiles.json instead. This helper

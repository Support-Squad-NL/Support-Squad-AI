...
describe("buildSandboxCreateArgs", () => {
  ...
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "supportsquadai-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "supportsquadai.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "supportsquadai-sbx-test",
        "--label",
        "supportsquadai.sandbox=1",
        "--label",
        "supportsquadai.sessionKey=main",
        "--label",
        "supportsquadai.createdAtMs=1700000000000",
        "--label",
        ...
        "--security-opt",
        "apparmor=supportsquadai-sandbox",
        "--dns",
        "1.1.1.1",
        "--add-host",
  ...
  it("omits -v flags when binds is empty or undefined", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "supportsquadai-sbx-no-binds",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
    });

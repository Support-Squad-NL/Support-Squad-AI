...
export const DEFAULT_SANDBOX_IMAGE = "supportsquadai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "supportsquadai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "supportsquadai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "supportsquadai-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "supportsquadai-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "supportsquadai-sandbox-browser";

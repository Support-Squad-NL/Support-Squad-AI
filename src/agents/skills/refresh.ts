...
function resolveWatchPaths(workspaceDir: string, config?: SupportSquadAIConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SupportSquadAIConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SupportSquadAIConfig }) {

...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("supportsquadai-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("supportsquadai-cache-test1-");
    const workspace2 = await makeTempWorkspace("supportsquadai-cache-test2-");

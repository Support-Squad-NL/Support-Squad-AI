...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveSupportSquadAIAgentDir() returns mainAgentDir
    process.env.SUPPORTSQUADAI_STATE_DIR = tmpDir;
    process.env.SUPPORTSQUADAI_AGENT_DIR = mainAgentDir;

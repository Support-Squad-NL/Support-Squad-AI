...
type SupportSquadAIReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: SupportSquadAIReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSupportSquadAIReadTool(base, {
...
export function createSupportSquadAIReadTool(
  base: AnyAgentTool,
  options?: SupportSquadAIReadToolOptions,
): AnyAgentTool {

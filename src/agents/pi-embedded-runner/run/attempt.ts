...
import { resolveSupportSquadAIDocsPath } from "../../docs-path.js";
...
import { createSupportSquadAICodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveSupportSquadAIAgentDir();
    ...
    const toolsRaw = params.disableTools
      ? []
      : createSupportSquadAICodingTools({
    ...
    const promptMode =
      isSubagentSessionKey(params.sessionKey) || isCronSessionKey(params.sessionKey)
        ? "minimal"
        : "full";
    const docsPath = await resolveSupportSquadAIDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/supportsquadai/supportsquadai/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt") {
          try {
            sessionManager.appendCustomEntry("supportsquadai:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/supportsquadai/supportsquadai/issues/8643

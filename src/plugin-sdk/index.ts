...
export type {
  ...
  SupportSquadAIPluginServiceContext,
  ProviderAuthContext,
  ProviderAuthResult,
...
export type { SupportSquadAIConfig } from "../config/config.js";
/** @deprecated Use SupportSquadAIConfig instead */
export type { SupportSquadAIConfig as ClawdbotConfig } from "../config/config.js";

...
const CORE_PACKAGE_NAMES = new Set(["supportsquadai"]);
...
export async function resolveSupportSquadAIPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSupportSquadAIPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {

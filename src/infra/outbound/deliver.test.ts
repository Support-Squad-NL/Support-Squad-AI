...
const telegramChunkConfig: SupportSquadAIConfig = {
  channels: { telegram: { botToken: "tok-1", textChunkLimit: 2 } },
};

const whatsappChunkConfig: SupportSquadAIConfig = {
...
describe("deliverOutboundPayloads", () => {
  ...
  it("uses signal media maxBytes from config", async () => {
    ...
    const cfg: SupportSquadAIConfig = { channels: { signal: { mediaMaxMb: 2 } } };

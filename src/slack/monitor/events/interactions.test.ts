...
describe("registerSlackInteractionEvents", () => {
  it("enqueues structured events and updates button rows", async () => {
    ...
    await handler!({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "supportsquadai:verify" }],
            },
          ],
        },
      },
      action: {
        type: "button",
        action_id: "supportsquadai:verify",
        block_id: "verify_block",
        value: "approved",
    ...
    expect(payload).toMatchObject({
      actionId: "supportsquadai:verify",
      actionType: "button",
      value: "approved",
      userId: "U123",
      teamId: "T9",
  ...
  it("falls back to container channel and message timestamps", async () => {
    ...
    await handler!({
      ...
      action: {
        type: "button",
        action_id: "supportsquadai:container",
  ...
  it("summarizes multi-select confirmations in updated message rows", async () => {
    ...
    await handler!({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "supportsquadai:multi" }],
            },
          ],
        },
      },
      action: {
        ...
        action_id: "supportsquadai:multi",
        block_id: "multi_block",
        selected_options: [
  ...
  it("renders date/time/datetime picker selections in confirmation rows", async () => {
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "supportsquadai:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "supportsquadai:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "supportsquadai:datetime" }],
            },
          ],
        },
      },
    ...
    await handler!({
      ...
      action: {
        type: "datetimepicker",
        action_id: "supportsquadai:datetime",
        block_id: "datetime_block",
  ...
  it("captures expanded selection and temporal payload fields", async () => {
    ...
    await handler!({
      ...
      action: {
        ...
        action_id: "supportsquadai:route",
        selected_user: "U777",
  ...
  it("captures workflow button trigger metadata", async () => {
    ...
    await handler!({
      ...
      action: {
        ...
        action_id: "supportsquadai:workflow",
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "supportsquadai:deploy_form",
          root_view_id: "VROOT",
    ...
    expect(payload).toMatchObject({
      ...
      actionId: "view:supportsquadai:deploy_form",
      callbackId: "supportsquadai:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V400",
          callback_id: "supportsquadai:routing_form",
          state: {
            values: {
              env_block: {
                env_select: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@supportsquadai.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.supportsquadai.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expect(payload.inputs).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          inputKind: "email",
          inputEmail: "team@supportsquadai.ai",
        }),
        expect.objectContaining({
          actionId: "url_input",
          inputKind: "url",
          inputUrl: "https://docs.supportsquadai.ai/",
        }),
        expect.objectContaining({
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "supportsquadai:long_richtext",
          state: {
            values: {
              richtext_block: {
                richtext_input: {

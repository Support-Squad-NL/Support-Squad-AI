...
// Prefix for SupportSquadAI-generated action IDs to scope our handler
const SUPPORTSQUADAI_ACTION_PREFIX = "supportsquadai:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${SUPPORTSQUADAI_ACTION_PREFIX}`);

  // Handle SupportSquadAI modal submissions with callback_ids scoped by our prefix.

...
function mergeSlackAccountConfig(cfg: SupportSquadAIConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SupportSquadAIConfig): ResolvedSlackAccount[] {

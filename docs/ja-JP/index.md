---
read_when:
  - 新規ユーザーにSupportSquadAIを紹介するとき
summary: SupportSquadAIは、あらゆるOSで動作するAIエージェント向けのマルチチャネルgatewayです。
...
<Columns>
  <Card title="はじめに" href="/start/getting-started" icon="rocket">
    SupportSquadAIをインストールし、数分でGatewayを起動できます。
  </Card>
  <Card title="ウィザードを実行" href="/start/wizard" icon="sparkles">
    `supportsquadai onboard`とペアリングフローによるガイド付きセットアップ。
  </Card>
...
SupportSquadAIは、単一のGatewayプロセスを通じてチャットアプリをPiのようなコーディングエージェントに接続します。SupportSquadAIアシスタントを駆動し、ローカルまたはリモートのセットアップをサポートします。
...
<Steps>
  <Step title="SupportSquadAIをインストール">
    ```bash
...
設定は`~/.supportsquadai/supportsquadai.json`にあります。

- **何もしなければ**、SupportSquadAIはバンドルされたPiバイナリをRPCモードで使用し、送信者ごとのセッションを作成します。

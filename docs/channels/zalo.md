...
- Install via CLI: `supportsquadai plugins install @supportsquadai/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `supportsquadai plugins install ./extensions/zalo`
   - From npm (if published): `supportsquadai plugins install @supportsquadai/zalo`
...
- Approve via:
  - `supportsquadai pairing list zalo`
  - `supportsquadai pairing approve zalo <CODE>`
...
- Example: `supportsquadai message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `supportsquadai channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `supportsquadai logs --follow`

---
summary: "Synology Chat webhook setup and SupportSquadAI config"
read_when:
  - Setting up Synology Chat with SupportSquadAI
...
```bash
supportsquadai plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your SupportSquadAI gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in SupportSquadAI.
...
- Pairing approvals work with:
  - `supportsquadai pairing list synology-chat`
  - `supportsquadai pairing approve synology-chat <CODE>`
...
```bash
supportsquadai message send --channel synology-chat --target 123456 --text "Hello from SupportSquadAI"
supportsquadai message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```

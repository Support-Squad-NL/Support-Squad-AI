...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure SupportSquadAI HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `supportsquadai pairing approve slack <code>`.
...
```bash
supportsquadai pairing list slack
```
...
SupportSquadAI supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, SupportSquadAI falls back to normal delivery for remaining payloads.

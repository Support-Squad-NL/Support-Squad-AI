...
read_when:
  - You want SupportSquadAI to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables SupportSquadAI to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`supportsquadai onboard`) and `supportsquadai channels add` list optional channel plugins.
...
```bash
supportsquadai plugins install @supportsquadai/nostr
```

Use a local checkout (dev workflows):

```bash
supportsquadai plugins install --link <path-to-supportsquadai>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "supportsquadai",
        "displayName": "SupportSquadAI",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "supportsquadai@example.com",
        "lud16": "supportsquadai@example.com"
      }
    }
  }
}

...
本指南总结了在 SupportSquadAI 中开发 Pi 集成的合理工作流程。
...
状态存储在 SupportSquadAI 状态目录下。默认为 `~/.supportsquadai`。如果设置了 `SUPPORTSQUADAI_STATE_DIR`，则使用该目录。

要重置所有内容：

- `supportsquadai.json` 用于配置
...
- https://docs.supportsquadai.ai/testing
- https://docs.supportsquadai.ai/start/getting-started

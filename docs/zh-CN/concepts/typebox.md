...
- 生成的 Swift 模型：`apps/macos/Sources/SupportSquadAIProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/supportsquadai/supportsquadai/main/dist/protocol.schema.json

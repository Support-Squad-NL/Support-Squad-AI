---
summary: "Use NVIDIA's OpenAI-compatible API in SupportSquadAI"
read_when:
  - You want to use NVIDIA models in SupportSquadAI
...
supportsquadai onboard --auth-choice skip
supportsquadai models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

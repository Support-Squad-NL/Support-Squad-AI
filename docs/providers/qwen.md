---
summary: "Use Qwen OAuth (free tier) in SupportSquadAI"
read_when:
  - You want to use Qwen with SupportSquadAI
...
If you already logged in with the Qwen Code CLI, SupportSquadAI will sync credentials

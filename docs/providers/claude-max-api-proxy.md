...
You can point SupportSquadAI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SupportSquadAI
...
- [Anthropic provider](/providers/anthropic) - Native SupportSquadAI integration with Claude setup-token or API keys

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SupportSquadAI"
read_when:
  - You want Xiaomi MiMo models in SupportSquadAI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SupportSquadAI uses

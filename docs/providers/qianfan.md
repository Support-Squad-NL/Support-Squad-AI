---
summary: "Use Qianfan's unified API to access many models in SupportSquadAI"
read_when:
...
3. SupportSquadAI installed on your system
...
4. Copy the API key for use with SupportSquadAI

## CLI setup

```bash
supportsquadai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SupportSquadAI Configuration](/gateway/configuration)

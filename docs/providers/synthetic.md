---
summary: "Use Synthetic's Anthropic-compatible API in SupportSquadAI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SupportSquadAI registers it as the
...
Note: SupportSquadAI's Anthropic client appends `/v1` to the base URL, so use

...
Deploy SupportSquadAI on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/supportsquadai` — Control UI
...
- `SUPPORTSQUADAI_STATE_DIR=/data/.supportsquadai` (recommended)
- `SUPPORTSQUADAI_WORKSPACE_DIR=/data/workspace` (recommended)
- `SUPPORTSQUADAI_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your SupportSquadAI state + workspace so you can migrate to another host without losing config or memory.

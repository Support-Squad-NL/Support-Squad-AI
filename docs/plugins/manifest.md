...
read_when:
  - You are building a SupportSquadAI plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (supportsquadai.plugin.json)

Every plugin **must** ship a `supportsquadai.plugin.json` file in the **plugin root**.
SupportSquadAI uses this manifest to validate configuration **without executing plugin

...
SupportSquadAI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.supportsquadai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["supportsquadai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

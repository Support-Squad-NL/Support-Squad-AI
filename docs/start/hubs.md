---
summary: "Hubs that link to every SupportSquadAI doc"
read_when:
...
<Note>
If you are new to SupportSquadAI, start with [Getting Started](/start/getting-started).
</Note>
...
- [SupportSquadAI assistant](/start/supportsquadai)

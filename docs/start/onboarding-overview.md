---
summary: "Overview of SupportSquadAI onboarding options and flows"
read_when:
...
SupportSquadAI supports multiple onboarding paths depending on where the Gateway runs
...
- [`supportsquadai onboard` command](/cli/onboard)

## macOS app onboarding

Use the SupportSquadAI app when you want a fully guided setup on macOS. Docs:

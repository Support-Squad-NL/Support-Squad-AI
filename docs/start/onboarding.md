---
summary: "First-run onboarding flow for SupportSquadAI (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SupportSquadAI">
...
<Step title="CLI">
  ...
  The app can install the global `supportsquadai` CLI via npm/pnpm so terminal

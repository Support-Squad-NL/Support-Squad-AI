...
#
# Output:
# - dist/SupportSquadAI.app
# - dist/SupportSquadAI-<version>.zip
# - dist/SupportSquadAI-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.supportsquadai.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/SupportSquadAI.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SupportSquadAI-$VERSION.zip"
DMG="$ROOT_DIR/dist/SupportSquadAI-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SupportSquadAI-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SupportSquadAI-$VERSION.dSYM.zip"

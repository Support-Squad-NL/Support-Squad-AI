...
- Keep product names in English: SupportSquadAI, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SupportSquadAI Gateway, use “Gateway 网关”.

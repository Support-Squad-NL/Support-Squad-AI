...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "supportsquadai", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for SupportSquadAI. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("SupportSquadAI Issue Label Audit");

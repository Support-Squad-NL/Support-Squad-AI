...
docker run --rm -t \
  ...
  -e SUPPORTSQUADAI_LIVE_MODELS="${SUPPORTSQUADAI_LIVE_MODELS:-${CLAWDBOT_LIVE_MODELS:-all}}" \
  -e SUPPORTSQUADAI_LIVE_PROVIDERS="${SUPPORTSQUADAI_LIVE_PROVIDERS:-${CLAWDBOT_LIVE_PROVIDERS:-}}" \
  -e SUPPORTSQUADAI_LIVE_MODEL_TIMEOUT_MS="${SUPPORTSQUADAI_LIVE_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e SUPPORTSQUADAI_LIVE_REQUIRE_PROFILE_KEYS="${SUPPORTSQUADAI_LIVE_REQUIRE_PROFILE_KEYS:-${CLAWDBOT_LIVE_REQUIRE_PROFILE_KEYS:-}}" \

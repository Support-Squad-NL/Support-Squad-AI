...
if [[ -z "$version_content" ]]; then
  echo "<h2>SupportSquadAI $VERSION</h2>"
  echo "<p>Latest SupportSquadAI update.</p>"
  echo "<p><a href=\"https://github.com/supportsquadai/supportsquadai/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

...
Nostr DM channel plugin for SupportSquadAI using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SupportSquadAI. It enables your bot to:
...
# Configure supportsquadai to use local relay

...
This directory contains the **BlueBubbles external channel plugin** for SupportSquadAI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `supportsquadai/plugin-sdk` helpers.

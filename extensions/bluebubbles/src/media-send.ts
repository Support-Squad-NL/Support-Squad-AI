...
import { resolveChannelMediaMaxBytes, type SupportSquadAIConfig } from "supportsquadai/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: SupportSquadAIConfig; accountId?: string }): string[] {

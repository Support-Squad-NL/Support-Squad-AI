import type { SupportSquadAIConfig, SupportSquadAIPluginApi } from "supportsquadai/plugin-sdk";
...
function resolveOwnershipAgent(config: SupportSquadAIConfig): { id: string; name: string } {

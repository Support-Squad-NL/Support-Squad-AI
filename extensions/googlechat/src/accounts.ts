...
export function listGoogleChatAccountIds(cfg: SupportSquadAIConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SupportSquadAIConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SupportSquadAIConfig): ResolvedGoogleChatAccount[] {

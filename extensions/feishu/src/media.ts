...
import { withTempDownloadPath, type ClawdbotConfig } from "supportsquadai/plugin-sdk";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "supportsquadai-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "supportsquadai-feishu-resource-",

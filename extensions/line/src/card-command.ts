import type { LineChannelData, SupportSquadAIPluginApi, ReplyPayload } from "supportsquadai/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: SupportSquadAIPluginApi): void {
  api.registerCommand({
    name: "card",

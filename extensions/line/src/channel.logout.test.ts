import type { SupportSquadAIConfig, PluginRuntime, ResolvedLineAccount } from "supportsquadai/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: SupportSquadAIConfig; accountId: string }): Promise<{

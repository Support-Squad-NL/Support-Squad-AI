...
function setMSTeamsDmPolicy(cfg: SupportSquadAIConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: SupportSquadAIConfig, allowFrom: string[]): SupportSquadAIConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,

...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "supportsquadai/plugin-sdk";
...
import { resolvePreferredSupportSquadAITmpDir } from "../../../src/infra/tmp-supportsquadai-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredSupportSquadAITmpDir(), "msteams-mention-"));

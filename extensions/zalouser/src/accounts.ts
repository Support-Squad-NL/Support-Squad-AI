...
export function listZalouserAccountIds(cfg: SupportSquadAIConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: SupportSquadAIConfig): string {
...
function mergeZalouserAccountConfig(cfg: SupportSquadAIConfig, accountId: string): ZalouserAccountConfig {

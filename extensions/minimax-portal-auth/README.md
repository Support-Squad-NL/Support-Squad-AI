# MiniMax OAuth (SupportSquadAI plugin)
...
```bash
supportsquadai plugins enable minimax-portal-auth
```
...
```bash
supportsquadai models auth login --provider minimax-portal --set-default
```

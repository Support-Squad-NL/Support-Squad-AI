import type { ChannelOnboardingAdapter, SupportSquadAIConfig, WizardPrompter } from "supportsquadai/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.supportsquadai.ai/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: SupportSquadAIConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,

...
export function listMattermostAccountIds(cfg: SupportSquadAIConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SupportSquadAIConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SupportSquadAIConfig): ResolvedMattermostAccount[] {

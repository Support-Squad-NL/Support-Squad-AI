...
- Version alignment with core SupportSquadAI release numbers.
...
- First public release of the @supportsquadai/voice-call plugin.
...
- CLI: `supportsquadai voicecall` commands (call/start/continue/speak/end/status/tail/expose).

...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "supportsquadai-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as SupportSquadAIApp);
      void loadAgents(host as unknown as SupportSquadAIApp);
      void loadToolsCatalog(host as unknown as SupportSquadAIApp);
      void loadNodes(host as unknown as SupportSquadAIApp, { quiet: true });
      void loadDevices(host as unknown as SupportSquadAIApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as SupportSquadAIApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as SupportSquadAIApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as SupportSquadAIApp);
  }
}

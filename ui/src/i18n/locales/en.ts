...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Edit ~/.supportsquadai/supportsquadai.json safely.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from supportsquadai dashboard --no-open on your desktop.",
    },
    insecure: {

...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.supportsquadai/supportsquadai.json com segurança.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando supportsquadai dashboard --no-open no desktop.",
    },
    insecure: {

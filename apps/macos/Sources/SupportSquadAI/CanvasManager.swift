...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.supportsquadai", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SupportSquadAI/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__supportsquadai__/a2ui/").absoluteString + "?platform=macos"
    }

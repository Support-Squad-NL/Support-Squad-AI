...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SupportSquadAIProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SupportSquadAIProtocol.AnyCodable("start"),
                "name": SupportSquadAIProtocol.AnyCodable("bash"),
            ],
            summary: nil)

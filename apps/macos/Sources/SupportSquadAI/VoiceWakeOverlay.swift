...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.supportsquadai", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SupportSquadAI windows, but below the system’s pop-up menus.

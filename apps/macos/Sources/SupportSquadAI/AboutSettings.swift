...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/supportsquadai/supportsquadai") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/supportsquadai/supportsquadai")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://supportsquadai.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SupportSquadAIBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SupportSquadAIBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SupportSquadAIGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SupportSquadAIGitCommit") as? String) ??
            "unknown"
    }

...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.supportsquadai", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".supportsquadai/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.supportsquadaiCommand(
            subcommand: "gateway",

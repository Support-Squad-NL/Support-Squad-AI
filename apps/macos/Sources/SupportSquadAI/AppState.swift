...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SupportSquadAIConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SupportSquadAIConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SupportSquadAIConfigFile.loadDict()
            ...
            SupportSquadAIConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/supportsquadai"
        state.remoteCliPath = ""
        return state
    }
}

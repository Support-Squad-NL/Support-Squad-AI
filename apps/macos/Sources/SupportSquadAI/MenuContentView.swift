...
/// Menu contents for the SupportSquadAI menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About SupportSquadAI") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "SupportSquadAI Not Configured"
        case .remote:
            "Remote SupportSquadAI Active"
        case .local:
            "SupportSquadAI Active"
        }
    }

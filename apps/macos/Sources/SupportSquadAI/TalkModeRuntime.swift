...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.supportsquadai", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.supportsquadai", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SupportSquadAIChatMessage] = messages.compactMap { item in

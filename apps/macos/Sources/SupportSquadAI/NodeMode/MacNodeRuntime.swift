...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case SupportSquadAILocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case SupportSquadAISystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case SupportSquadAISystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case SupportSquadAISystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case SupportSquadAISystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case SupportSquadAISystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case SupportSquadAICanvasA2UICommand.push.rawValue,
             SupportSquadAICanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__supportsquadai__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(SupportSquadAISystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(SupportSquadAISystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: SupportSquadAISystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> SupportSquadAILocationMode {
    ...
    private static func errorResponse(
        ...
        code: SupportSquadAINodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: SupportSquadAINodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: SupportSquadAICanvasSnapshotFormat,
        maxWidth: Int?,

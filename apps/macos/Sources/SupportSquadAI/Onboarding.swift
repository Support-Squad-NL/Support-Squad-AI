...
enum UIStrings {
    static let welcomeTitle = "Welcome to SupportSquadAI"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "supportsquadai.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SupportSquadAIOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SupportSquadAIChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g supportsquadai@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SupportSquadAIChatViewModel(

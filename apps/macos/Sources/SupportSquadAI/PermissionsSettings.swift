...
struct PermissionsSettings: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("Allow these so SupportSquadAI can notify and capture when needed.")
                .padding(.top, 4)
...
private struct LocationAccessSettings: View {
    @AppStorage(locationModeKey) private var locationModeRaw: String = SupportSquadAILocationMode.off.rawValue
    ...
    private var locationMode: SupportSquadAILocationMode {
        SupportSquadAILocationMode(rawValue: self.locationModeRaw) ?? .off
    }

    private func requestLocationAuthorization(mode: SupportSquadAILocationMode) async -> Bool {

...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.supportsquadai", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: SupportSquadAIPeekabooBridgeServices?
    private static var supportsquadaiSocketPath: String {
        let fileManager = FileManager.default
        let base = fileManager.urls(for: .applicationSupportDirectory, in: .userDomainMask).first
            ?? fileManager.homeDirectoryForCurrentUser.appendingPathComponent("Library/Application Support")
        let directory = base.appendingPathComponent("SupportSquadAI", isDirectory: true)
    ...
    private func startIfNeeded() async {
        ...
        let services = SupportSquadAIPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: Self.supportsquadaiSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(Self.supportsquadaiSocketPath, privacy: .public)")
    }
...
@MainActor
private final class SupportSquadAIPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "ai.supportsquadai.peekaboo")

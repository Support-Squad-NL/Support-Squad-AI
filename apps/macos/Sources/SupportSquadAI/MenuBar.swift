...
struct SupportSquadAIApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.supportsquadai", category: "app")
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.supportsquadai", category: "Chat")

...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .supportsquadaiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SupportSquadAIPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SupportSquadAIPaths.stateDirURL.path
...
extension Notification.Name {
    static let supportsquadaiSelectSettingsTab = Notification.Name("supportsquadaiSelectSettingsTab")
}

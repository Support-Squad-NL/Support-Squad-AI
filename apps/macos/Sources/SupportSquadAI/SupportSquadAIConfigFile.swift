...
enum SupportSquadAIConfigFile {
    private static let logger = Logger(subsystem: "ai.supportsquadai", category: "config")
    ...
    static func stateDirURL() -> URL {
        SupportSquadAIPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SupportSquadAIPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-supportsquadai-config-file",
            "event": "config.write",

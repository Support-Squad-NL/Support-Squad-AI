## SupportSquadAI Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_supportsquadai-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm supportsquadai gateway --port 18789 --verbose
```

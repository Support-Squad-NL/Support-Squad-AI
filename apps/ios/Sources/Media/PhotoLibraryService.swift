...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SupportSquadAIPhotosLatestParams) async throws -> SupportSquadAIPhotosLatestPayload {
        ...
        var results: [SupportSquadAIPhotoPayload] = []
        ...
        return SupportSquadAIPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SupportSquadAIPhotoPayload
    {
        ...
        return SupportSquadAIPhotoPayload(
            format: "jpeg",

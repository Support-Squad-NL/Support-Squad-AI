...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.supportsquadai.gateway"
    private static let nodeService = "ai.supportsquadai.node"
    private static let talkService = "ai.supportsquadai.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.supportsquadai.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.supportsquadai.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("supportsquadai-gateway.log")
    }

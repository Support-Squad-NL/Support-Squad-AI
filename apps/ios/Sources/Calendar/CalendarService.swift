...
final class CalendarService: CalendarServicing {
    func events(params: SupportSquadAICalendarEventsParams) async throws -> SupportSquadAICalendarEventsPayload {
        ...
        let payload = selected.map { event in
            SupportSquadAICalendarEventPayload(
        ...
        return SupportSquadAICalendarEventsPayload(events: payload)
    }
    ...
    func add(params: SupportSquadAICalendarAddParams) async throws -> SupportSquadAICalendarAddPayload {
        ...
        let payload = SupportSquadAICalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return SupportSquadAICalendarAddPayload(event: payload)
    }

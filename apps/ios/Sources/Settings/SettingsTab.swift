...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = SupportSquadAILocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = SupportSquadAILocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.supportsquadai.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected SupportSquadAI agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips while SupportSquadAI is foregrounded.")
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for SupportSquadAI. Off disables location tools, While Using enables foreground location, and Always enables background location.")
                            } label: {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(SupportSquadAILocationMode.off.rawValue)
                            Text("While Using").tag(SupportSquadAILocationMode.whileUsing.rawValue)
                            Text("Always").tag(SupportSquadAILocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while SupportSquadAI is open.")
                            ...
                            HStack(spacing: 8) {
                                ...
                                Button {
                                    self.activeFeatureHelp = FeatureHelp(
                                        ...
                                        message: "Appends this instruction when sharing content into SupportSquadAI from iOS.")
                                } label: {
                                    Image(systemName: "info.circle")
                                        .foregroundStyle(.secondary)
                                }
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("SupportSquadAI", value: self.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = SupportSquadAILocationMode(rawValue: newValue) else { return }
                Task {

...
actor CameraController {
    ...
    func snap(params: SupportSquadAICameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: SupportSquadAICameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("supportsquadai-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("supportsquadai-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: SupportSquadAICameraFacing,

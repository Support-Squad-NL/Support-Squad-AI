...
/// Handles navigation policy to intercept supportsquadai:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept supportsquadai:// deep links.
        if url.scheme?.lowercased() == "supportsquadai" {

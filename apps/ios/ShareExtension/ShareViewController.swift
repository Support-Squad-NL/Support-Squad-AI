...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.supportsquadai.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to SupportSquadAI", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to SupportSquadAI gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to SupportSquadAI.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "SupportSquadAIShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "SupportSquadAI is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "SupportSquadAI Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("supportsquadai-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in

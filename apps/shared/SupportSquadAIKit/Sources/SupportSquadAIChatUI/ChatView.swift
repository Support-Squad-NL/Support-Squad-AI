...
@MainActor
public struct SupportSquadAIChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SupportSquadAIChatViewModel
    ...
    public init(
        viewModel: SupportSquadAIChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                SupportSquadAIChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [SupportSquadAIChatMessage] {
        let base: [SupportSquadAIChatMessage]
    ...
    private func mergeToolResults(in messages: [SupportSquadAIChatMessage]) -> [SupportSquadAIChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SupportSquadAIChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SupportSquadAIChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SupportSquadAIChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SupportSquadAIChatMessage) -> String {

...
enum SupportSquadAIChatTheme {
    ...
    static let assistantBubbleDynamicNSColor = NSColor(
        name: NSColor.Name("SupportSquadAIChatTheme.assistantBubble"),
        dynamicProvider: resolvedAssistantBubbleColor(for:))

    static let onboardingAssistantBubbleDynamicNSColor = NSColor(
        name: NSColor.Name("SupportSquadAIChatTheme.onboardingAssistantBubble"),
...
enum SupportSquadAIPlatformImageFactory {
    static func image(_ image: SupportSquadAIPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)

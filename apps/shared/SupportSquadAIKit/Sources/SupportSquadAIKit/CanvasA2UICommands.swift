...
public enum SupportSquadAICanvasA2UICommand: String, Codable, Sendable {
...
public struct SupportSquadAICanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SupportSquadAICanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
